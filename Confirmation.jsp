			...
			<table class="table table-striped">
				...
				<tbody>
						<%try{
							...
							Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/tourism","root","root");
							...
							while(rs.next()){
								...
								<td><%=packagecost %></td>
								<%
								Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3307/tourism","root","root");
								...
								Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3307/tourism","root","root");
								...
								Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost:3307/tourism","root","root");
								...
								Connection con4 = DriverManager.getConnection("jdbc:mysql://localhost:3307/tourism","root","root");
